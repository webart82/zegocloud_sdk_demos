...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    ...
    // init SDK
    ZEGOSDKManager.instance.init(SDKKeyCenter.appID, kIsWeb ? null : SDKKeyCenter.appSign);
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  if (kIsWeb) {
                    ...
                    token = ZegoTokenUtils.generateToken(SDKKeyCenter.appID, SDKKeyCenter.serverSecret, userIDTextCtrl.text);
                  }
